<template>
    <v-footer :app="false" color="teal" height="auto" > 
                    ...
                    <v-container>
                        ...
                        <v-row class="text-center">
                            <div>
                                ...
                                <p class="font-italic text-caption">Los contenidos son manifestaciones de libre expresión y no reflejan una postura institucional.</p> 
                            </div>
                        </v-row>
                    </v-container>  
                </v-col>
