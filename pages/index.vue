<template>
    ...
    <v-btn color="secondary" class="ma-4">
    ...
    <v-btn @click="dialog = true; color = 'primary'" color="primary">
        Primary
    </v-btn>
    <v-btn @click="dialog = true; color = 'secondary'" color="secondary">
        Secondary
    </v-btn>
    <v-btn @click="dialog = true; color = 'accent'" color="accent">
        Accent
    </v-btn>
